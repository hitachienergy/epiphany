...
| nfs-utils | + | | + |
| nmap-ncat | + | | ? |
| elasticsearch-alerting-1.13.1* | + | | + |
| elasticsearch-index-management-1.13.1* | + | | + |
| elasticsearch-job-scheduler-1.13.1* | + | | + |
| elasticsearch-performance-analyzer-1.13.1* | + | | + |
| elasticsearch-security-1.13.1* | + | | + |
| elasticsearch-sql-1.13.1* | + | | + |
