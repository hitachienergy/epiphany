...
| nfs-utils | + | | + |
| nmap-ncat | + | | ? |
| opensearch-alerting-1.10.1* | + | | + |
| opensearch-index-management-1.10.1* | + | | + |
| opensearch-job-scheduler-1.10.1* | + | | + |
| opensearch-performance-analyzer-1.10.1* | + | | + |
| opensearch-security-1.10.1* | + | | + |
| opensearch-sql-1.10.1* | + | | + |
