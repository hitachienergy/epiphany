...
| Filebeat Helm Chart        | 7.8.1    | https://github.com/elastic/helm-charts                | [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
...
| docutils | 0.16 | http://docutils.sourceforge.net/ | public domain, Python, 2-Clause BSD, GPL 3 (see COPYING.txt) |
