...
- [Security](./howto/SECURITY.md)
  ...
  - [How to use TLS/SSL certificate with OpenSearch Dashboards](./howto/SECURITY.md#how-to-use-tlsssl-certificate-with-opensearch-dashboards)
...
- [Databases](./howto/DATABASES.md)
  ...
  - [How to manage OpenSearch data](./howto/LOGGING.md#how-to-manage-opensearch-data)
...
- [Data and log retention](./howto/RETENTION.md)
  - [OpenSearch](./howto/RETENTION.md#opensearch)
  - [Grafana](./howto/RETENTION.md#grafana)
  - [Kafka](./howto/RETENTION.md#kafka)
  - [OpenSearch Dashboards](./howto/RETENTION.md#opensearch-dashboards)
