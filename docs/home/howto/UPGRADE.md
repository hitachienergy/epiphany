...
- `--upgrade-components`. Specify comma separated component names so the upragde procedure will only process specific ones. If this flag is not provided then upgrade procedure will process all the components. 
   Example:
   ```shell
