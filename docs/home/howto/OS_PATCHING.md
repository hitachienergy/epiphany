...
- RHEL: `RHEL-8.4.0_HVM-20230419-x86_64-41-Hourly2-GP2` (kernel 4.18.0-305.12.1.el8_4.x86_64),
- Ubuntu: `ubuntu/images/hvm-ssd/ubuntu-focal-20.04-amd64-server-20231004` (kernel 5.15.0-1021-aws).
...
- Ubuntu: `Canonical:0001-com-ubuntu-server-focal:20_04-lts-gen2:20.04.202308310` (kernel 5.15.0-1021-azure).
