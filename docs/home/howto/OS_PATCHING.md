...
- Ubuntu: `ubuntu/images/hvm-ssd/ubuntu-focal-20.04-amd64-server-20220104` (kernel 5.11.0-1023-aws).
...
- Ubuntu: `Canonical:0001-com-ubuntu-server-focal:20_04-lts-gen2:20.04.202201040` (kernel 5.11.0-1023-azure).
