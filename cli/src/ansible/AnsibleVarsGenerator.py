...
class AnsibleVarsGenerator(Step):
    ...
    def generate(self):
        ...
        if self.is_upgrade_run:
            ...
            roles_with_defaults = [
                'grafana', 'jmx_exporter', 'kafka', 'kafka_exporter',
                'node_exporter', 'opensearch', 'opensearch_dashboards',
            ...
            # In special cases, where user specifies majority of the config, it's easier (and less
            ...
            roles_with_manifest = ['filebeat', 'repository']
        else:
