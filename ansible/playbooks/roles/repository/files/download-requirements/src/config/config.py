...
class Config:
    ...
    def __log_info_summary(self):
        ...
        if self.full_download:
            lines.append('--full-download flag used, downloading all available requirements...')
    ...
    def __create_parser(self) -> ArgumentParser:
        ...
        parser.add_argument('--full-download', action='store_true', dest='full_download',
                            help='download all available requirements')
