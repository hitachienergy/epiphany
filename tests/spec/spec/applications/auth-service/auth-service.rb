...
def callAuthServiceDeploymentTests
  ...
  service_admin_user = readDataYaml('configuration/applications')['specification']['applications'].detect do |i|
                         i['name'] == 'auth-service'
                       end ['service']['admin_user']
  service_admin_password = readDataYaml('configuration/applications')['specification']['applications'].detect do |i|
                             i['name'] == 'auth-service'
                           end ['service']['admin_password']
