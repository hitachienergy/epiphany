...
rabbitmq_deployment = false
rabbitmq_deployment_array_index = nil
auth_service_deployment = false
auth_service_array_index = nil


if readDataYaml.dig("kubernetes","deployments") && !readDataYaml["kubernetes"]["deployments"].index {|h| h["name"] == "rabbitmq" }.nil?
    rabbitmq_deployment = true
...
if readDataYaml.dig("kubernetes","deployments") && !readDataYaml["kubernetes"]["deployments"].index {|h| h["name"] == "auth-service" }.nil?
  auth_service_deployment = true
  auth_service_array_index = readDataYaml["kubernetes"]["deployments"].index {|h| h["name"] == "auth-service" }
end


# Start of the test section for RabbitMQ deployment

if rabbitmq_deployment
...
# End of the test section for RabbitMQ deployment


# Start of the test section for auth-service deployment

if auth_service_deployment
...
# End of the test section for auth-service deployment
