...
case $ARCH in
  x86_64)
    readonly ARCH_EXTENSION="x86_64"
    ;;

  aarch64)
    readonly ARCH_EXTENSION="arm64"
    ;;
...
readonly REQUIREMENTS_FILE_PATH="$SCRIPT_DIR/requirements_$ARCH_EXTENSION.txt"
readonly ADD_REPOSITORIES="$SCRIPT_DIR/add-repositories-$ARCH_EXTENSION.sh"
