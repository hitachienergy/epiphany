...
class AWSConfigBuilder(InfrastructureConfigBuilder):
    ...
    def get_autoscaling_group(self, cluster_model, component_key, component_value, subnet_name, user_input):
        ...
        autoscaling_group.specification.name = 'aws-asg-' + cluster_model.specification.cloud.cluster_name.lower() + '-' + component_key.lower()
    ...
    def get_launch_configuration(self, autoscaling_group, cluster_model, component_key, security_group_name, user_input):
        ...
        launch_configuration.specification.name = 'aws-launch-config-' + cluster_model.specification.cloud.cluster_name.lower() + '-' + component_key.lower()
    ...
    def get_route_table_association(self, cluster_model, user_input, route_table_name, subnet_name, subnet_index):
        ...
        route_table_association.specification.name = 'aws-route-association-' + \
                                                           cluster_model.specification.cloud.cluster_name.lower() + '-' + str(subnet_index)
