aws_templates_paths = {
    ...
    "infrastructure/network": "static/terraform_templates_aws/network_template.tf.j2",
    "epiphany-cluster": "static/terraform_templates_aws/epiphany_cluster.tf.j2",
    "configuration/kubernetes-master": "static/terraform_templates_aws/kubernetes_master.tf.j2",
    "configuration/kubernetes-node": "static/terraform_templates_aws/kubernetes_node.tf.j2",
...
azure_templates_paths = {
    ...
    "configuration/kubernetes-master": "static/terraform_templates_azure/kubernetes_master.tf.j2",
    "configuration/kubernetes-node": "static/terraform_templates_azure/kubernetes_node.tf.j2",
